...
int mlx90640_check_new_data(uint8_t slaveAddr) {
    uint16_t statusRegister;
    int ret = MLX90640_I2CRead(slaveAddr, MLX90640_STATUS_REG, 1, &statusRegister);
    if (ret != 0) return 0; // Error reading status register
    return MLX90640_GET_DATA_READY(statusRegister);
}
...
int MLX90640_GetFrameData(uint8_t slaveAddr, uint16_t *frameData)
{
    ...
    // if (!mlx90640_check_new_data(slaveAddr))
...
{
    // int error = 0;
    // printf("ExtractVDDParameters\n");
    // ExtractVDDParameters(eeData, mlx90640);
    // printf("ExtractPTATParameters \n");
    // ExtractPTATParameters(eeData, mlx90640);
    // printf("ExtractGainParameters \n");
    // ExtractGainParameters(eeData, mlx90640);
    // printf("ExtractTgcParameters \n");
    // ExtractTgcParameters(eeData, mlx90640);
    // printf("ExtractResolutionParameters \n");
    // ExtractResolutionParameters(eeData, mlx90640);
    // printf("ExtractKsTaParameters \n");
    // ExtractKsTaParameters(eeData, mlx90640);
    // printf("ExtractKsToParameters \n");
    // ExtractKsToParameters(eeData, mlx90640);
    // printf("ExtractCPParameters \n");
    // ExtractCPParameters(eeData, mlx90640);

    // printf("ExtractAlphaParameters \n");
    // ExtractAlphaParameters(eeData, mlx90640);
    // printf("ExtractOffsetParameters \n");
    // ExtractOffsetParameters(eeData, mlx90640);
    // printf("ExtractKtaPixelParameters \n");
    // ExtractKtaPixelParameters(eeData, mlx90640);
    // printf("ExtractKvPixelParameters \n");
    // ExtractKvPixelParameters(eeData, mlx90640);
    // printf("ExtractCILCParameters \n");
    // ExtractCILCParameters(eeData, mlx90640);
    // printf("ExtractDeviatingPixels pixel\n");
    // error = ExtractDeviatingPixels(eeData, mlx90640);  
    // printf("ExtractParameters end\n");
    // return error;
...
static void ExtractAlphaParameters(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
    ...
    printf("ExtractAlphaParameters end\n");
}
